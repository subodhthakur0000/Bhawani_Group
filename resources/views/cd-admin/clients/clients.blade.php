...
<section class="content" style="padding: 40px;">
	<div class="row">
    <div>
        <a href="{{url('/addclients')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Client</button></a>
   ...
   @if(Session::has('success'))
      ...
      <div style="height: 85px;">
       <form action="{{url('/statuscl/'.$car->id)}}" method="POST" class="pull-left">
                      {{csrf_field()}}
                    <div class="btn-group">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="{{url('deleteclient/'.$ser->id)}}"><button type="button" class="btn btn-outline">Yes</button></a>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
