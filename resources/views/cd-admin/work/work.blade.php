...
<section class="content" style="padding: 40px;">
	<div class="row">
    <div>
        <a href="{{url('/addwork')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Work</button></a>
   ...
   @if(Session::has('success'))
      ...
      <div style="height: 85px;">
       <form action="{{url('/statuswork/'.$car->id)}}" method="POST" class="pull-left">
                      {{csrf_field()}}
                    <div class="btn-group">
...
<div class="modal modal-danger fade" id="modal-danger{{$ser->id}}">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="{{url('deletework/'.$ser->id)}}"><button type="button" class="btn btn-outline">Yes</button></a>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"><strong>Project Name :</strong>{{$ser->name}}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
