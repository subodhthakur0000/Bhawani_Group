        ...
        <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                 <a href="{{url('/addsection')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Section</button></a>
              </h3>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$pa->title}}</td>
                  <td height="75px">
                     <form action="{{url('/statussec/'.$pa->id)}}" method="POST">
                      {{csrf_field()}}
                    <div class="btn-group">
...
<div class="modal modal-danger fade" id="modal-danger{{$t->id}}">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
               ...
               <a href="{{url('/deletesec/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form role="form" action= "{{url('editsection/'.$t->id)}}" enctype="multipart/form-data" method="post">
          {{csrf_field()}}
            
               <div class="form-group">
                <label for="imgalt">Section Title </label>
                <div class="text text-danger">{{$errors->first('title')}}</div>
                <input type="text" class="form-control" name="title" id="alt" placeholder="Title Of Section" value="{{$t['title']}}">
            </div>
